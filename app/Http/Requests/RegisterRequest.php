...
class RegisterRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email' => ['required','string', 'email:rfc,dns','max:255','unique:users'], // validate email is required, string, valid, and max 255 characters
            'phone_number' => ['required','string','max:255','unique:users'], // validate phone_number is required, string, and max 255 characters
